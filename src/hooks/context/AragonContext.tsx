...
export function AragonSDKWrapper({ children }: AragonSDKWrapperContext) {
  ...
  useEffect(() => {
    const aragonSDKContextParams: ContextParams = {
      ...
      graphqlNodes: [
        {
          url: 'https://subgraph.satsuma-prod.com/qHR2wGfc5RLi6/aragon/osx-mainnet/version/v1.0.0/api', // "https://subgraph.satsuma-prod.com/qHR2wGfc5RLi6/aragon/osx-goerli/version/v1.0.0/api", // url: "https://subgraph.satsuma-prod.com/aragon/core-goerli-2/api",
        },
      ],
    };
  ...
  return (
    <AragonContext.Provider value={{ context, baseClient, tokenVotingClient }}>
      {children}
...
export function useAragon() {
  return useContext(AragonContext);
}
